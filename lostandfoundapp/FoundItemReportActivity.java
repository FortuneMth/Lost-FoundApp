...
public class FoundItemReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_found_item_report);
    ...
    private void proceedToLocation() {
        Intent intent = new Intent(this, FoundItemLocationActivity.class);
