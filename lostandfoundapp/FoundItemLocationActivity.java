...
public class FoundItemLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_found_item_location);
    ...
    private void proceedToReview() {
        ...
        Intent intent = new Intent(this, FoundItemReviewActivity.class);
        intent.putExtra("itemName", itemName);
        intent.putExtra("category", category);
        intent.putExtra("description", description);
        intent.putExtra("foundDate", foundDate);
        intent.putExtra("foundTime", foundTime);
