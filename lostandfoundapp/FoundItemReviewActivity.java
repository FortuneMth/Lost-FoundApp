...
public class FoundItemReviewActivity extends AppCompatActivity {
    private static final String TAG = "FoundItemReview";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_found_item_review);
        ...
        foundDate = intent.getStringExtra("foundDate");
        foundTime = intent.getStringExtra("foundTime");
    ...
    private void displayReviewData() {
        ...
        reviewDate.setText(foundDate != null ? foundDate : "N/A");
        reviewTime.setText(foundTime != null ? foundTime : "N/A");
    ...
    private void submitReport() {
        ...
        // Create Item object (isLost = false for found items)
        Item item = new Item(
            itemName,
            description,
            category,
            ...
            "", // imageUrl
            "", // userId
            false // isLost - this is a FOUND item
        );
        ...
        FirebaseUtils.saveItem(item, new FirebaseUtils.OnItemSaveListener() {
            ...
            public void onSuccess(String itemId) {
                ...
                Toast.makeText(FoundItemReviewActivity.this, 
                    "Found item reported successfully!", Toast.LENGTH_SHORT).show();
                
                Log.d(TAG, "Starting ReportSuccessActivity");
                // Navigate to success screen
                Intent intent = new Intent(FoundItemReviewActivity.this, ReportSuccessActivity.class);
                intent.putExtra("itemId", itemId);
                intent.putExtra("itemType", "found");
